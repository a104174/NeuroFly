...
unchanged.
Phase 6A adds a validated presentation mapping for persisted experiment state:
LC4/LPLC2 drives stay type-level, while exact DNp01 point-neuron state can be
